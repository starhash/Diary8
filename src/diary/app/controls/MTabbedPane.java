...
public class MTabbedPane extends javax.swing.JComponent {
    ...
    public void setSelectedTab(int SELECTED_TAB) {
        ...
        jSplitPane1.setDividerLocation((tabType==VERTICAL)?180:30);
        tabViews.revalidate();
        tabViews.repaint();
        tabHeads.revalidate();
        tabHeads.repaint();
    ...
    private void initComponents() {
        ...
        tabHeads.setLayout(new org.jdesktop.swingx.VerticalLayout());
